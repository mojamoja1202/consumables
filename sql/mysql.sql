...
CREATE TABLE `consumables_add` (
  `add_sn` int(10) UNSIGNED NOT NULL COMMENT '增購索引',
...
CREATE TABLE `consumables_get` (
  `get_sn` int(10) UNSIGNED NOT NULL COMMENT '領取索引',
...
CREATE TABLE `consumables_teacher` (
  `teacher_sn` int(11) NOT NULL COMMENT '教師名稱索引',
...
CREATE TABLE `consumables_item` (
  `item_sn` int(10) UNSIGNED NOT NULL COMMENT '消耗品索引',
